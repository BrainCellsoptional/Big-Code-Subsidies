...
class Display():
    ...
    def page1(self):
        ...
        self.image_button1 = Button(container, image=self.tk_image1,command=lambda:(self.destroy(),self.page2(0,"F-14B TomCat")))
        ...
        self.image_button2 = Button(container, image=self.tk_image2,command=lambda:(self.destroy(),self.page2(1,"F-4E Phantom")))
        ...
        self.image_button3 = Button(container, image=self.tk_image3,command=lambda:(self.destroy(),self.page2(2,"MIG-23ML Flogger")))
        ...
        self.image_button4 = Button(container, image=self.tk_image4,command=lambda:(self.destroy(),self.page2(3,"SU-27 Flanker")))
    ...
    def page2(self,selected_aircraft,air_name):
        page_num = 2
        self.create()
