...
class Display():
    def __init__(self):
        ...
        #Aircraft Image lists, also Contaion Pilon Information
        ...
        #Aircraft Lists are put Into a List
        ...
        #Missile images, Also Contain Missile Keys and Paths
        ...
        #Information About Missisles with a key
        self.missile_info = {
    ...
    #Testing Missile Page for F-4E Phantom input
    def test1(self):
        test_ans = [1,"F-4E Phantom",2]
        self.page1()
        self.image_button2.invoke()
        for x in range(3):
            if self.test_list1[x] == test_ans[x]:
                print(f"Test 1-{x}: Passed")
            else:
                print(f"Test 1-{x}: Failed")

    
    #Testing Missile Pages, when R-73 is selected for SU-27 Outer Pilons 
    def test2(self):
        test_ans = [2,"r73"]
        self.page1()
        self.image_button4.invoke()
        self.test_list2[0].invoke()

        for x in range(2):
            if self.test_list2[x+1] == test_ans[x]:
                print(f"Test 2-{x}: Passed")
            else:
                print(f"Test 2-{x}: Passed")


    #Testing Missile Pages, when Aim 7F is selected
    def test3(self):
        test_ans = [3,"aim7f"]
        self.page1()
        self.image_button1.invoke()
        print(self.button_list)
        self.button_list[0].invoke()
        self.button_list[2].invoke()

        if self.test_list3[0] == test_ans[0]:
            print("Test 3-1: Passed")
        else:
            print("Test 3-1: Failed")
        if self.test_list3[1][1] == test_ans[1]:
    ...
    #Caculates Payload Weight and Outputs Static Aircraft Information
    ...
    #Calculates Range and Total weight Bassed of Usser selected Fuel Load
    #Multipule Values change in real Time Making this fluid instead of static
    ...
    #Reads Previously saved Loadout and Displays Info
    #Curently Code will fail Unless the CSV file has Information in it 
    def read(self):
        try:
            ...
            self.previous = "No Previous Data"


    #Saves Information when the usser Saves & Exits
    ...
    #If the Usser Selectets the Previous Loadout then this function skips to the Output Screen
    def skip(self):
        for x in range(3):
            if x < len(self.keys):
    ...
    #Page 1
    def page1(self):
        #Used in Test 2 and 3, resets key list
        self.missile_keys_list = []
    ...
    def missile_pages(self,selected_aircraft,air_name,page_num):
        #Used For Test 1
        self.test_list1 = [selected_aircraft,air_name,page_num]
        #Used in Test 3, resets list
        self.button_list = []
        ...
        if page_num <=3:
            ...
            for num in range(4):
                if num < len(selected_list[selected_aircraft]):
                    ...
                    #Used for Test 3
                    self.button_list.append(missile)
            ...
            #Used In Test 2
            self.test_list2 = [missile,page_num,self.missile_keys_list]
            #Used in Test 3
            self.test_list3 = [page_num,self.missile_keys_list]
    ...
    def output_display(self,selected_aircraft,air_name,page_num):
        #Calls the Payload Weight Function and saves the Output To a variable
        ...
        #Displays Static Information About Selected Aircraft
        ...
        for value in range(3):
            if value < len(self.missile_image_list):
                ...
                #Finds relevent Missile Information from dictonary 
                text_output = self.missile_info[self.missile_keys_list[value]]

                #Displays Relevent Text and number of missiles equiped
                #God dam what a long as widget
                ...
                #Places Empty Widgets if only 2 Pilons are avalible so widgets dont get spaced weirdly
                place_holder = Label(container4,bg="black",width=32,height=10)
                place_holder.grid(row=value,column=0,pady=(0,10))

        #Contains The Fluid Information widgets
        ...
        #Fuel Slider Alows the User To Select the amount of fuel
        #Widget Calls for Fluid Information whenever the number changes
        fuel_num = IntVar()
